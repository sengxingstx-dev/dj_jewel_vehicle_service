"""
Django settings for dj_jewel_vehicle_service project.
...
ROOT_URLCONF = 'dj_jewel_vehicle_service.urls'
...
WSGI_APPLICATION = 'dj_jewel_vehicle_service.wsgi.application'
...
LOGIN_URL = 'login'  # Specify the URL to redirect users to if they are not logged in
LOGOUT_URL = 'home'
